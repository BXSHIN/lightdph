...
class SupConResNet(nn.Module):
    ...
    def __init__(self, name='resnet50', head='mlp', feat_dim=128):
        ...
        # dim_in may need to be modified for skin images (e.g., 2048 -> 224)
...
class SupConEfficientNet(nn.Module):
    ...
    def __init__(self, name='efficientnet-b4', head='mlp', feat_dim=128, 
        ...
        ## the following cls is redundent.
        ## just already trained some encoders so keep it here
...
class LHACv1(nn.Module):
    ...
    def forward(self, x):
        # print("input x: ", x.size())
        _, x = self.encoder(x) # for efficientnet
        # x = self.encoder(x) # for resnet
